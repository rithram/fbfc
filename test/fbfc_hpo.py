...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-N', '--non_binary', help='Whether to use non-binary FBFs',
    ...
    parser.add_argument(
        '-B', '--max_batch_size', help='Maximum batch size for FBFC training',
    ...
    print('-'*30)
    res_dir = 'results/fbfc+hpo/' + timestamp
    ...
    fname = res_dir + '/fbfc.hpo.results.' + timestamp + '.csv'
